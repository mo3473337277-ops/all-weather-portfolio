...
|------|:----:|:----:|:--------:|:-----:|--------|
| **V3c 多元** | 简约派 | 8.36% | -7.01% | 1.58 | 6 资产逆波动率 60d + nonferr 趋势 + HS300 AND 抄底 |
| **V3-B 风险平价(20d)** | 学院派 | **10.15%** | -9.25% | 1.40 | 4 桶等权 RP + nonferr/gold/sp500 趋势 + Gold/HS300 抄底 |
| **V3-B 保守增强(20d)** | 保守增强 | 6.90% | **-6.40%** | 1.66 | 逆波动率 20d + nonferr 趋势 + HS300 AND 抄底 |

> V3-B RP 使用 nonferr(75d) + gold(75d) + sp500(120d) 三重趋势过滤。V3c 和 V3-B Con 使用 nonferr(75d) 趋势过滤 + HS300 AND 抄底。V3-B RP 不含 bond_10y（CAGR +1.43pp, Sharpe -0.02）。V3c 和 V3-B Con 已关闭 gold dip-buying（一致性改善）。
...
**V3-B 保守增强(20d) (保守增强)** — 逆波动率加权（20d 回看，max_w=0.25）+ nonferr 趋势过滤 + HS300 AND 抄底。含 bond_10y（7 资产）。回撤最低(-6.40%)，Sharpe 最高(1.66)，熊市表现最好，年化成本拖累仅 0.21%。适合保守资金、退休金、无法忍受大幅回撤。
