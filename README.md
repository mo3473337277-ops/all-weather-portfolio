...
| **V3-B 风险平价桶(20d)** | 预算派 | 8.38% | -8.13% | **1.66** | 4桶逆波动率 RP + 同趋势过滤 — 桶风险最均衡 |
...
> V3c = 6资产; B-RP = 6资产 4桶(无 bond_10y); B-风险平价桶 = B-RP 的桶间逆波动率版; B-Con = 7资产 5桶(含 bond_10y)。
...
**V3-B 风险平价桶(20d) (预算派)**
- 4桶逆波动率 HRP + 同三重趋势过滤 + Gold/HS300 抄底
- 桶风险最均衡(max/min 3.85x)，Sharpe 最高(1.66)，所有年份正收益
- 适合: 追求风险均衡、Sharpe 优先、无法接受负收益年份
...
| 桶 | 资产 | V3c | V3-B RP | V3-B 风险平价桶 | V3-B Con |
|----|------|:---:|:-------:|:-------------:|:--------:|
| 增长↑ | hs300, us_sp500 | ✓ | ✓ | ✓ | ✓ |
| 收益垫 | credit | ✓ | ✓ | ✓ | ✓ |
| 增长↓10Y | bond_10y | — | — | — | ✓ |
