...
|---|---|---|---|---|---|
| **V3c 多元** | 实战派 | 7.45% | -6.71% | 1.26 | 要最优 CAGR，简单落地 |
| **V3-B (20d)** | 学院派 | 7.72% | -4.89% | 1.36 | 认同桥水方法论，战术灵活 |
| **V3-B 保守增强(60d)** | 保守派 | 6.86% | -3.57% | 1.98 | 睡得着觉，回撤最低，Sharpe最优 |

> V3c 看回测，V3-B 看方法论+动量过滤，保守增强看夏普和回撤。
>
> 回测期：2015-01 ~ 2025-12（~11 年）
> 调仓规则：V3c 半年节点 + 3% 偏离阈值；V3-B 20d 窗口月度调仓 + nonferr 趋势过滤
