...
| **V3c 多元** | 多元全天候 | **9.68%** | 4.68% | -7.63% | 1.60 | 7 资产逆波动率 60d + nonferr/sp500 趋势(75d) + HS300 AND 抄底 |

> V3-B RP 四重趋势过滤：nonferr(75d) + gold(75d) + sp500(75d) + hs300(30d)；V3c 双趋势过滤：nonferr(75d) + sp500(75d)。不含 bond_10y（CAGR +1.43pp, Sharpe -0.02）。V3c 多元 7 资产逆波动率 60d，同样不含 bond_10y。本表为**不含原油**版本（7 资产），含原油对比见下方。
...
| **V3c 多元** | 无原油 | **9.68%** | 4.68% | -7.63% | **1.60** | 1.27 |
| | +原油 | 9.44% | 5.09% | **-6.74%** | 1.42 | **1.40** |
