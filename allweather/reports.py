...
def print_summary_recommendation():
    ...
    cards = [
        ("V3c 多元", "★★★", "简约派", "6资产逆波动率 60d + nonferr趋势 + HS300抄底",
         ["+ 资产最少(6个)，执行最简单",
          "+ 低回撤(-4.40%)，回报稳健(8.34%)",
          "+ 每月调仓一次，交易频率低",
          "- 无桶级风控，单资产上限 30% 较宽松",
        ...
        ("V3-B 风险平价(20d)", "★★★", "学院派", "4桶等权 HRP + nonferr趋势 + Gold趋势 + HS300抄底",
         ["+ 长期回报最高 CAGR 10.40%，累计 508%",
        ...
        ("V3-B 保守增强(20d)", "★★★", "保守增强", "逆波动率 20d + nonferr趋势 + HS300抄底，max_w=0.25",
         ["+ 回撤最低(-3.42%)，零负收益年份",
          "+ Sharpe 最高(1.84)，风险调整后效率最优",
          "+ 熊市表现最好(2022 +2.5%，2018 +7.1%)",
          "- 牛市可能跑输(2019仅+7.53%，2017仅+2.92%)",
          "- 长期累计回报最低(276%)"],
